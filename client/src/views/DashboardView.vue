<template>
    <div class="container-fluid" v-if="user">
        <div class="row">
            <!-- Sidebar -->
            <div class="sidebar col-md-3 col-lg-2 bg-dark text-white" style="height: 100vh;">
            ...
            <!-- Content -->
            <div class="col-md-9 col-lg-10 bg-white" style="height: 100vh;">
                <div id="page-content">
                    ...
                    <ReportsContainer v-else-if="currentDisplayedContent =='ReportsContainer'" />
                </div>
            </div>
        </div>
    </div>
...
import ReportsContainer from '@/components/Report/ReportsContainer.vue';
  ...
  data () {
    return {
        ...
        sidebarItems:[ // those are the sidebar items
            ...
            {text: 'Reports',        icon: 'fas fa-chart-bar me-2',        content: 'ReportsContainer'},
        ]
    }
  },
  async created() {
