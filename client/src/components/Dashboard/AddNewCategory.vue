                                    ...
                                    <div class="card-body">
                                        <form @submit.prevent="onSubmit">
                                            <div class="mb-3">
                                                ...
                                                <input v-model="categoryName" type="text" class="form-control" id="categoryName" name="categoryName" placeholder="Enter category name" required>
                                                <div v-if="!categoryName" class="alert alert-danger m-2" role="alert">
